...
namespace IndianStateCensusAnalyserTest
{
    ...
    public class Tests
    {
        ...
        static string wrongIndiaStateCensusData = @"C:\Users\Chandru\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSV_Files\WrongIndiaStateCensusData.csv";
        static string wrongFileIndiaStateCensusData = @"C:\Chandru\tusha\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSVFiles\WrongIndiaStateCensusData.csv";
        static string indiaStateCensusDataText = @"C:\Users\Chandru\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSV_Files\IndiaStateCensusDAta.txt";
        static string delimiterIndiaStateCensusData = @"C:\Users\Chandru\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSV_Files\DelimiterIndiaStateCensusData.csv";
        static string indianStateCensusHeaders = "State,Population,AreaInSqKm,DensityPerSqKm";

        //StateCode
        static string indiaStateCode = @"C:\Users\Chandru\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSV_Files\IndiaStateCode.csv";
        static string indiaStateCodeText = @"C:\Users\Chandru\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSV_Files\IndiaStateCode.txt";
        static string delimiterIndiaStateCode = @"C:\Users\Chandru\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSV_Files\DelimiterIndiaStateCode.csv";
        static string wrongIndiaStateCode = @"C:\Users\Chandru\source\repos\IndianStateCensusAnalyser\IndianStateCensusAnalyser\CSV_Files\WrongIndiaStateCode.csv";
